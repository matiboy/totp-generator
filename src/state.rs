...
pub struct State {
    ...
    pub secrets_cf: Arc<ConfigFile>,
    pub buffer: String,
    pub number_style: NumberStyle,
}

impl State  {
   pub fn default(secrets_cf: Arc<ConfigFile>, lock_password: Option<String>, lock_after_seconds: u16, number_style: NumberStyle) -> State {
       State {
        secrets_cf,
        lock_password,
